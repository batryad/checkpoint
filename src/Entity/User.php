...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Profil", mappedBy="profil_user", cascade={"persist", "remove"})
     */
    private $profil;
    ...
    {
        if ($this->user_post->contains($userPost)) {
            $this->user_post->removeElement($userPost);
    ...
    public function setProfil(?Profil $profil): self
    {
        ...
        $newProfil_user = null === $profil ? null : $this;
        if ($profil->getProfilUser() !== $newProfil_user) {
            $profil->setProfilUser($newProfil_user);
        }
